...
object ReimbursementClaimsRequestFormat {
  ...
  implicit val reimbursementClaimsRequestFormat: OFormat[ReimbursementClaimsRequest] =
    Json.format[ReimbursementClaimsRequest]
}
